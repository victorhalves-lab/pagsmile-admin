  ...
  return (
    <FormSection title="1. Informações Cadastrais" subtitle="Dados básicos da empresa" icon={Building2}>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        ...
        <div className="space-y-1">
          <Label className="text-xs">Início Atividade</Label>
          <Input 
            className="h-9 text-sm"
            type="date" 
        ...
        <div className="space-y-1 md:col-span-2">
          <Label className="text-xs">Endereço Comercial Registrado (CNPJ) *</Label>
          <Textarea 
        ...
        <div className="space-y-1 md:col-span-2">
          <Label className="text-xs">Outros Escritórios *</Label>
          <Textarea 
