...
export default function Step14_PLD_Monitoramento({ formData, handleChange }) {
  return (
    <FormSection title="PLD/FT - Parte 3" subtitle="Operação e Monitoramento" icon={Shield}>
      <div className="space-y-4">
        {[
          { id: 'pld10', label: 'Atua como plataforma de apostas? *' },
          { id: 'pld11', label: 'Atua com criptomoedas/tokens? *' },
          { id: 'pld12', label: 'Oferece produtos restritos (tabaco, adulto, armas)? *' }
        ].map((p) => (
