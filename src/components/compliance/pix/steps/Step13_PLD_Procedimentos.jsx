...
export default function Step13_PLD_Procedimentos({ formData, handleChange }) {
  return (
    <FormSection title="PLD/FT - Parte 2" subtitle="Histórico e Riscos" icon={Shield}>
      <div className="space-y-4">
        {[
          { id: 'pld4', label: 'Transações com parceiros com histórico de fraudes/irregularidades? *' },
          { id: 'pld5', label: 'Histórico de pagamentos indevidos/propina? *' },
