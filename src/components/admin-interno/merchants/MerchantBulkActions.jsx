  ...
  return (
    <>
        ...
        footer={
          <div className="flex justify-end gap-3">
            ...
            <Button
              variant="destructive"
              onClick={handleBlock}
              disabled={!blockReason || blockJustification.length < 50 || blockConfirmation !== 'BLOQUEAR'}
            >
              <Ban className="w-4 h-4 mr-2" /> Bloquear
            </Button>
          </div>
      ...
      >
        <div className="space-y-4">
          ...
          <div>
            ...
            <Textarea placeholder="Descreva em detalhes a razão do bloqueio..." value={blockJustification} onChange={(e) => setBlockJustification(e.target.value)} rows={4} />
            <p className="text-xs text-slate-500 mt-1">Mínimo 50 caracteres</p>
          </div>

          <div className="space-y-2">
            <div className="flex items-center space-x-2">
              <Checkbox id="notify" checked={notifyMerchants} onCheckedChange={setNotifyMerchants} />
              <Label htmlFor="notify">Notificar merchants por e-mail</Label>
            </div>
            <div className="flex items-center space-x-2">
              <Checkbox id="subaccounts" checked={blockSubaccounts} onCheckedChange={setBlockSubaccounts} />
          ...
          <div>
            ...
            <Input placeholder="BLOQUEAR" value={blockConfirmation} onChange={(e) => setBlockConfirmation(e.target.value.toUpperCase())} />
          </div>
        </div>
      </SideDrawer>
      ...
      <SideDrawer
        ...
        description={`Merchants selecionados: ${selectedCount}`}
        icon={Tag}
        footer={
          <div className="flex justify-end gap-3">
            <Button variant="outline" onClick={() => setShowTagsModal(false)}>Cancelar</Button>
      ...
      >
        <div className="space-y-4">
          ...
          <p className="text-sm text-slate-500">⚠️ Merchants que já possuem estas tags não serão afetados.</p>
        </div>
      </SideDrawer>
      ...
      >
        <div className="space-y-4">
          ...
          <p className="text-sm text-slate-500">⚠️ Merchants já pertencentes a este grupo não serão afetados.</p>
        </div>
      </SideDrawer>
      ...
      <SideDrawer
        ...
        description={`Destinatários: ${selectedCount} merchants`}
        icon={Mail}
        size="lg"
        footer={
          <div className="flex justify-end gap-3">
      ...
      >
        <div className="space-y-4">
          <div>
            ...
            <Select>
              <SelectTrigger><SelectValue placeholder="Selecione um template ou escreva do zero..." /></SelectTrigger>
              <SelectContent>
          ...
          <div>
            ...
            <Textarea placeholder="Olá {{nome_contato}},&#10;&#10;Gostaríamos de informar..." rows={8} />
