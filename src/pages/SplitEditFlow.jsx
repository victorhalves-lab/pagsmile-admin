...
export default function SplitEditFlow() {
  ...
  // Detecta mudanças e enriquece com sensibilidade
  ...
  const respectsNotice =
    !requiresNotice || cutover.mode === 'immediate' ? false : proposedDate && proposedDate >= minDate;
  ...
  return (
    <div className="space-y-5 min-h-screen">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <MentorSplitProposedConfigEditor
          current={current}
          proposed={proposed}
