...
import { 
  ...
  Image, File, AlertCircle, X
} from 'lucide-react';
import { cn } from '@/lib/utils';

const requiredDocuments = [
  { id: 'cnpj_card', name: 'Cartão CNPJ', description: 'Documento emitido pela Receita Federal', required: true },
  { id: 'social_contract', name: 'Contrato Social com última alteração', description: 'Documento de constituição da empresa', required: true },
  { id: 'partners_id', name: 'Documento de identidade dos sócios', description: 'RG ou CNH de todos os sócios', required: true },
  ...
  { id: 'partners_selfie', name: 'Selfie dos sócios com o documento', description: 'Foto segurando o documento de identidade', required: true },
  { id: 'partners_address_proof', name: 'Comprovante de endereço dos sócios', description: 'Conta de luz, água ou telefone (últimos 90 dias)', required: true },
  { id: 'balance_sheet', name: 'Balanço patrimonial último exercício', description: 'Demonstrativo contábil', required: true },
  { id: 'dre', name: 'DRE último exercício', description: 'Demonstração do Resultado do Exercício', required: true },
  { id: 'balancete', name: 'Balancete último exercício', description: 'Balancete contábil mais recente', required: true },
  { id: 'pld_policy', name: 'Política de PLD', description: 'Política de Prevenção à Lavagem de Dinheiro', required: true },
];
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 py-8 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500">Envie os documentos necessários para análise</p>
          <div className="max-w-md mx-auto mt-4">
            <div className="flex justify-between text-sm text-gray-500 mb-1">
              <span>{uploadedCount} de {requiredCount} documentos</span>
